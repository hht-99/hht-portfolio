...
🔗 [LinkedIn](https://linkedin.com/in/harry-h-tran/) • [GitHub](https://github.com/hht-99)


---

## What I Do
- Clean and analyse real-world datasets  
- Build Python automation scripts  
- Develop reproducible data pipelines  
- Solve logic-based problems
- Demonstrate my ability to work with JSON/APIs
...
[View Project](https://github.com/hht-99/data_and_software-portfolio/blob/main/project-phd-ligandbased_fragmentgrowing_pipline/README.md)

---

### Transactional Data Management
![badge](https://img.shields.io/badge/Data-Storing-purple)  
Wrote a script that provides a model system For Transactional Data Management.  

[View Project](https://github.com/hht-99/data_and_software-portfolio/blob/main/project-02-transactional_data_management/README.md)

---

### JSON Data Retrieval and Sanitisation
![badge](https://img.shields.io/badge/API-JSON-red)  
Created a script capable of retrieving real-world data safely through industry-standard sanitisation checks. 

[View Project](https://github.com/hht-99/data_and_software-portfolio/blob/main/project-03-JSON_API_data_processing_handling/README.md)

---

## Technical Skills
`Python` `Pandas` `NumPy` `Matplotlib` `Sklearn` `RDKit`   
`Excel` `Git` `Data Pipelines` `Scientific Reasoning` `JSON`  
